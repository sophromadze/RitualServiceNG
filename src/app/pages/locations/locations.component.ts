        ...
        const infoWindowContent = `
          <div style="padding: 8px; max-width: 200px; font-size: 12px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 6px;">
              <a onclick="window.location.href='tel:+995555429710'" style="color: #5184ed; display: flex; align-items: center; text-decoration: none; font-size: 11px; cursor: pointer;">
                <i class="fa-solid fa-phone" style="margin-right: 4px;"></i>+995 555 42 97 10
              </a>
